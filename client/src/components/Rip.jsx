...
function Rip() {
  ...
  useEffect(() => {
    ...
    const fetchFlowers = async () => {
      try {
        const response = await axios.get(`/api/v1/flowers/post/${_id}`, {
          headers: {
            Authorization: `Bearer ${currentUser?.data.accessToken}`,
          },
        });
    ...
    const fetchPrayers = async () => {
      try {
        const response = await axios.get(
          `/api/v1/prayers/post/${_id}`, // Fetch prayers for this RIP
          {
            headers: {
              Authorization: `Bearer ${currentUser?.data.accessToken}`,
            },
    ...
    const fetchPhotos = async () => {
      try {
        const response = await axios.get(
          `/api/v1/photos/post/${_id}`, // Fetch prayers for this RIP
          {
            headers: {
              Authorization: `Bearer ${currentUser?.data.accessToken}`,
            },
    ...
    const fetchMemorablia = async () => {
      try {
        const response = await axios.get(
          `/api/v1/memorablias/post/${_id}`, // Fetch prayers for this RIP
          {
            headers: {
              Authorization: `Bearer ${currentUser?.data.accessToken}`,
            },
    ...
    const fetchDocuments = async () => {
      try {
        const response = await axios.get(
          `/api/v1/documents/post/${_id}`, // Fetch documents for this RIP
          {
            headers: {
              Authorization: `Bearer ${currentUser?.data.accessToken}`,
            },
